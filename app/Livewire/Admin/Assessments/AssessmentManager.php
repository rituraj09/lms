    ...
    public function addGroupToAssessment(): void
    {
        ...
        if ($this->pickerMode === 'existing' && $this->pickerAgIndex !== null) {
            ...
            $this->assessmentGroups[] = [
                ...
                'allow_back_to_group_question'    => false,
                'allow_back_to_previous_question' => false,
                'group_timer'                     => 0,
                'admin_note'                      => '',
            ...
            DB::transaction(function () {
                ...
                foreach ($this->assessmentGroups as $agIndex => $agData) {
                    ...
                    $agPayload = [
                        ...
                        'allow_back_to_group_question'    => (bool) ($agData['allow_back_to_group_question'] ?? false),
                        'allow_back_to_previous_question' => (bool) ($agData['allow_back_to_previous_question'] ?? false),
