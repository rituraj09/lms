...
<div class="min-h-screen bg-light py-4 py-lg-5">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" wire:model.live="name" placeholder="e.g. john.doe"
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" wire:model="mobile" placeholder="9876543210" inputmode="numeric"
                                    maxlength="10"
                                    class="form-control border-start-0
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="password" wire:model="password" placeholder="Enter secure password"
                                    class="form-control border-start-0
                                        ...
                                        <div class="col-12 col-md-4 ps-5">
                                            ...
                                            <div class="form-check ">
                                                <input class="form-check-input cursor-pointer" type="checkbox"
                                                    wire:model.live="organisation_ids" value="{{ $org->id }}"
                                                    id="org{{ $org->id }}" />
                                                <label class="form-check-label cursor-pointer w-95 ps-2"
                                                    for="org{{ $org->id }}">
                                                    <div class="d-flex align-items-center gap-2">
                                                        {{-- Logo --}}
                                                        @if ($org->logo)
                                                            <img src="{{ Storage::url($org->logo) }}"
                                                                alt="{{ $org->name }}" class="rounded"
    ...
    <style>
        ...
        {{-- Status button groups --}} .btn-group .btn-check:checked+.btn {
            font-weight: 600;
        }

        {{-- Smooth transitions --}} .btn,
        .form-control,
        .form-select {
            transition: all 0.2s ease;
        }

        {{-- Password requirements badges --}} .badge {
            font-weight: 500;
            padding: 0.35rem 0.65rem;
        }

        {{-- Alert styling --}} .alert-sm {
            padding: 0.5rem 1rem;
            font-size: 0.875rem;
        }

        {{-- Organization card styling --}} .form-check {
            padding: 0.75rem;
        ...
        {{-- Input group text styling --}} .input-group-text {
            background-color: #f8f9fa;
        }

        {{-- Header icons styling --}} .card-header {
            background-color: #f8f9fa;
        }
