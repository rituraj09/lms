...
<div class="assessment-manager-wrapper">
    ...
    @if (session()->has('success'))
        <div class="alert alert-success alert-dismissible fade show
                    d-flex align-items-center gap-2 mb-4" role="alert">
                    ...
                    <div class="border-bottom px-4 py-3"
                        ...
                        <div class="d-flex align-items-start
                            ...
                            <div class="d-flex gap-2 flex-shrink-0">
                                ...
                                <button type="button"
                                        wire:click="toggleStatus({{ $assessment->id }})"
                                        class="btn btn-sm {{ $assessment->status === 'publish' ? 'btn-outline-warning' : 'btn-outline-success' }}">
                                    <i class="ri {{ $assessment->status === 'publish' ? 'ri-eye-off-line' : 'ri-eye-line' }}"></i>
                                </button>
                                @if ($assessment->status !== 'publish')
                                    <button type="button"
                ...
                @if (empty($assessmentGroups))
                    <div class="card shadow-sm border-0">
                        <div class="card-body text-center py-5 text-muted">
                            <i class="ri ri-layout-grid-line"
                               style="font-size:3rem;opacity:.3;"></i>
                    ...
                    @foreach ($assessmentGroups as $agIndex => $ag)
                        ...
                        <div class="card shadow-sm border-0 mb-4"
                            ...
                            <div class="card-header py-3 border-bottom"
                                ...
                                <div class="d-flex align-items-start
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button"
                                                wire:click="openAddMoreQuestions({{ $agIndex }})"
                            ...
                            <div class="card-body p-0">
                                ...
                                @if ($ag['questions_category'] === 'multiple'
                                     && !empty($ag['group_content']['content']))
                                    @php
                                ...
                                <div class="p-4 border-bottom bg-light">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea
                                                wire:model="assessmentGroups.{{ $agIndex }}.instructions"
                                                class="form-control form-control-sm"
                                                rows="2"
                                                placeholder="Instructions shown before this group...">
                                            </textarea>
                                        </div>
                                                    ...
                                                    <div class="row g-2 align-items-end">
                                                        ...
                                                        @if ($has_negative_mark)
                                                            <div class="col-md-4">
                                                                <label class="form-label fw-medium mb-1"
                                                                       style="font-size:.75rem;">
                                                                    <i class="ri ri-subtract-line me-1 text-danger"></i>
                                                                    Negative Mark
                                                                </label>
                                                                <input type="number"
                    ...
                    <div class="modal-content border-0 shadow-lg">
                        ...
                        <div class="modal-header border-bottom">
                            <h5 class="modal-title fw-bold">
                                ...
                                @if ($pickerMode === 'existing')
                                    <i class="ri ri-add-large-line text-success me-2"></i>
                                    Add More Questions
                                    @if ($pickerAgIndex !== null)
                        ...
                        <div class="modal-body p-0">
                            <div class="row g-0" style="min-height:500px;">
                                ...
                                {{-- LEFT — Group List (only in 'new' mode) --}}
                                @if ($pickerMode === 'new')
                                    ...
                                    <div class="col-md-5 border-end"
                                        ...
                                        <div class="list-group list-group-flush">
                                                    ...
                                                    <div class="d-flex align-items-start gap-2">
                                                        <div class="flex-1">
                                                            ...
                                                            <div class="d-flex gap-2 flex-wrap">
                                                                <span class="badge {{ $pickerGroupId === $pg->id ? 'bg-white text-primary' : 'bg-primary-subtle text-primary' }}"
                                            ...
                                            @empty
                                                <div class="text-center py-5 text-muted">
                                                    <i class="ri ri-folder-open-line fs-2 opacity-50"></i>
                                                    <p class="small mt-2">No groups found.</p>
                                                </div>
                                            @endforelse
                                ...
                                <div class="{{ $pickerMode === 'new' ? 'col-md-7' : 'col-12' }}"
                                     style="max-height:600px;overflow-y:auto;">
                                    ...
                                    @if (! $pickerGroupId)
                                        ...
                                        <div class="d-flex align-items-center
                                            ...
                                            <div class="text-center">
                                                <i class="ri ri-arrow-left-line fs-2 opacity-50"></i>
                                                <p class="small mt-2">
                                                    Select a group to see its questions.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        ...
                                        @php
                                            $selectedGroup = null;
                                            if ($pickerMode === 'new') {
                                                $selectedGroup = $pickerGroups->firstWhere('id', $pickerGroupId);
                                                $selectedContent = $selectedGroup?->group_content ?? [];
                                            } else {
                                                $selectedContent = $assessmentGroups[$pickerAgIndex]['group_content'] ?? [];
                                            }
                                            $passageEn = $selectedContent['content'][array_key_first($languages)] ?? '';
                                            $isPassage = $pickerMode === 'existing'
                                                ? ($assessmentGroups[$pickerAgIndex]['questions_category'] === 'multiple')
                                                : ($selectedGroup?->questions_category === 'multiple');
                                        @endphp

                                        @if ($isPassage && $passageEn)
                                            <div class="p-3 border-bottom bg-info-subtle">
                                                <p class="small fw-semibold text-info mb-2">
                                                    <i class="ri ri-file-text-line me-1"></i>
                                                    Group Passage
                                        ...
                                        <div class="p-3">
                                            ...
                                            @foreach ($pickerQuestions as $pq)
                                                ...
                                                <div class="border rounded-3 mb-2 overflow-hidden
                                                            {{ $pq['already_used'] ? 'opacity-50' : '' }}"
                                                     wire:key="pq-{{ $pq['id'] }}">

                                                    <label class="d-flex align-items-start gap-3 p-3
                                                                  {{ in_array($pq['id'], $pickerSelectedQIds) ? 'bg-primary-subtle' : 'bg-white' }}"
                                                        ...
                                                        <div class="flex-1">
                                                            <p class="mb-1 small fw-medium text-dark">
                                                                {{ Str::limit($pq['stem_en'] ?: '(No English stem)', 80) }}
                                                            </p>
                                                            <div class="d-flex flex-wrap gap-2">

                                                                @if ($pq['answer_category'] === 'single_optional')
                                                                    <span class="badge bg-primary-subtle text-primary"
                                                                          style="font-size:.65rem;">Single</span>
                                                                @elseif ($pq['answer_category'] === 'multi_optional')
                                                                    <span class="badge bg-info-subtle text-info"
                                                                          style="font-size:.65rem;">Multi</span>
                                                                @else
                                                                    <span class="badge bg-secondary-subtle text-secondary"
                                                                          style="font-size:.65rem;">Open</span>
                                                                @endif
                        ...
                        <div class="modal-footer border-top">
                            ...
                            <button type="button"
                                    wire:click="addGroupToAssessment"
                                    wire:loading.attr="disabled"
                                    class="btn btn-primary btn-sm"
                                    @if(!$pickerGroupId || empty($pickerSelectedQIds)) disabled @endif>
