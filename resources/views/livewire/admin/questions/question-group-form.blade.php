                    ...
                    @if ($questions_category === 'multiple')
                        ...
                        @if(!$isGroupLocked && !$groupContentImage)
                            <label for="groupContentImageInput"
                                ...
                                {{-- Idle state --}}
                                <div wire:loading.remove wire:target="groupContentImage">
                                    <i class="ri ri-image-add-line text-primary mb-2" style="font-size:2rem;"></i>
                                    <p class="fw-semibold mb-1 small">Click to upload image</p>
