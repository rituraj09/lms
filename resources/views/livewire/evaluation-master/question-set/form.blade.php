                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            {{-- Set Type --}}
                            <div class="col-md-4">
                                <label class="form-label fw-medium small">Set Type <span class="text-danger">*</span></label>
                                ...
                                @error('questionSetType') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            {{-- Age Group --}}
                            <div class="col-md-4">
                                <label class="form-label fw-medium small">Age Group <span class="text-danger">*</span></label>
                                ...
                                @error('ageGroupId') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            ...
                            {{-- Description --}}
                            <div class="col-12">
                                <label class="form-label fw-medium small">Description <span class="text-muted">(optional)</span></label>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" wire:model="timer"
                                    ...
                                    min="1" max="65535" placeholder="e.g. 3600" />
                            ...
                            {{-- Passing Score --}}
                            <div class="col-md-4">
                                <label class="form-label fw-medium small">Passing Score <span class="text-muted">(optional)</span></label>
                                <input type="number" wire:model="passingScore"
                                    class="form-control"
                                    min="0" placeholder="e.g. 70" />
                                <div class="form-text small">Minimum score required to pass.</div>
                            </div>

                            {{-- Status --}}
                            <div class="col-md-4">
                                <label class="form-label fw-medium small">Status <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        wire:model="randomizeQuestions" id="randomize" />
                                    <label class="form-check-label fw-medium small" for="randomize">
                                        Randomize question order
                                    </label>
                                </div>
                                <div class="form-text small">Questions will appear in random order for each candidate.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        @if ($imagePath)
                            <div class="position-relative d-inline-block mb-3">
                                <img src="{{ Storage::url($imagePath) }}"
                                     alt="Cover" class="img-thumbnail w-100 rounded"
                        ...
                        @if (! $imagePath)
                            ...
                            @error('imageUpload')
                                <div class="text-danger small mt-1"><i class="ri ri-error-warning-line me-1"></i>{{ $message }}</div>
                            @enderror
                        @endif
                        ...
                        @if ($imageUpload)
                            <div class="mt-3 d-flex align-items-start gap-2">
                                <img src="{{ $imageUpload->temporaryUrl() }}"
                                     class="img-thumbnail rounded" style="max-height:100px;object-fit:cover;">
                                <div>
                                    <p class="small fw-medium mb-1">{{ $imageUpload->getClientOriginalName() }}</p>
                                    <p class="small text-muted mb-2">{{ number_format($imageUpload->getSize() / 1024, 1) }} KB</p>
                ...
                <div class="card border-0 bg-opacity-5 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-column gap-2">
                            @foreach ([
                                ['num' => 1, 'label' => 'Set Details', 'desc' => 'Title, type, timer', 'done' => true],
                                ['num' => 2, 'label' => 'Add Groups',  'desc' => 'Organise into sub-groups', 'done' => false],
                                ['num' => 3, 'label' => 'Add Questions', 'desc' => 'Pick questions per group', 'done' => false],
                            ] as $step)
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <div class="small fw-semibold {{ $step['done'] ? 'text-primary' : 'text-muted' }}">
                                            {{ $step['label'] }}
                                        </div>
...
<style>
    ...
    .upload-dropzone:hover { border-color: var(--bs-primary) !important; }
</style>
@endpush
