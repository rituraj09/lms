<div class="row g-4">
    <div class="d-flex align-items-center">
        <img src="{{ $viewOrganisation->logo_path
            ? asset('storage/' . $viewOrganisation->logo_path)
            : asset('assets/img/avatars/2.png') }}"
            alt="logo" class="rounded border border-2 border-white me-3"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        @if ($viewOrganisation->website)
                            <a href="{{ $viewOrganisation->website }}" target="_blank" class="fw-medium">
